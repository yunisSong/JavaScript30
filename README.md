...
Javascript30是在Github上看到的一个旨在使用纯Js来进行练习，原项目地址是[wesbos-JavaScript30](https://github.com/wesbos/JavaScript30)，感谢  wesbos 提供的非常优秀的教程。这里主要记录学习的过程中学到的东西。
   ...
   * [JavaScript30](#javascript30)
         * [01 - JavaScript Drum Kit](#01---javascript-drum-kit)
            ...
            * [3. class 添加。删除值](#3-class-添加删除值)
            * [4. 查找 class 为 key 的全部元素](#4-查找-class-为-key-的全部元素)
            * [5. 添加监听事件](#5-添加监听事件)
         * [02 - JS and CSS Clock](#02---js-and-css-clock)
            * [1. 获取当前时间](#1-获取当前时间)
            * [2. 定时器调用](#2-定时器调用)
            * [3. 视图动画变换](#3-视图动画变换)
            * [4. 设置视图动画变化的锚点](#4-设置视图动画变化的锚点)
         * [03 - CSS Variables](#03---css-variables)
            * [1. 声明 css 变量](#1-声明-css-变量)
            * [2. 使用 css 变量](#2-使用-css-变量)
            * [3. 元素的值集合](#3-元素的值集合)
            * [4. 选择器的多个选择条件](#4-选择器的多个选择条件)
         ...
         * [06 - Type Ahead](#06---type-ahead)
            ...
            * [正则表达式替换字符串](#正则表达式替换字符串)
         * [07 - Array Cardio Day 2](#07---array-cardio-day-2)
         * [some](#some)
         * [every](#every)
         * [find](#find)
         * [findIndex](#findindex)
         * [根据index删除特定的元素](#根据index删除特定的元素)
         * [08 - Fun with HTML5 Canvas](#08---fun-with-html5-canvas)
         * [09 - Dev Tools Domination](#09---dev-tools-domination)
         ...
         * [14 - JavaScript References VS Copying](#14---javascript-references-vs-copying)
